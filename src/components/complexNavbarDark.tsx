        ...
        >
          <ul className="navbar-nav ms-md-auto  justify-content-end">
            ...
            <li className="px-3 nav-item d-flex align-items-center">
              <a href="#" className="p-0 text-white nav-link">
                <svg
                  ...
                  className="cursor-pointer fixed-plugin-button-nav"
                  viewBox="0 0 24 24"
                  fill="currentColor"
                >
                  <path
            ...
            <li className="nav-item dropdown pe-2 d-flex align-items-center">
              <a
                href="#"
                className="p-0 text-white nav-link"
            ...
            <li className="nav-item d-flex align-items-center ps-2">
              <a
                href="#"
                className="px-0 text-white nav-link font-weight-bold"
              ></a>
            </li>
            <li className="nav-item dropdown pe-2 d-flex align-items-center">
      ...
      <div className="container pt-3 pb-3">
        <ul className="navbar-nav d-none d-lg-flex">
          <li className="nav-item dropdown px-3 py-3 border-radius-sm bg-slate-800 d-flex align-items-center">
            <a
              href="#"
              className="p-0 text-white dropdown-toggle nav-link"
              id="dropdownProfile"
              data-bs-toggle="dropdown"
              aria-expanded="true"
            >
            ...
            <ul
              className="dropdown-menu dropdown-xl"
        ...
        <div className="p-0 ms-md-auto d-flex align-items-center">
          <div className="input-group border-dark">
            ...
            <input
              type="text"
              className="form-control max-width-200 border-dark bg-dark"
              placeholder="Search"
            />
          </div>
        </div>
