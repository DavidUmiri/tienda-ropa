          ...
          <div className="card shadow-xs border">
            <div className="card-body p-3 d-flex">
              <div className="icon icon-shape bg-dark text-white text-center border-radius-sm d-flex align-items-center justify-content-center">
                ...
                >
                  <path
                    d="M9.6 19.8C9.6 20.7941 8.79412 21.6 7.8 21.6C6.80588 21.6 6 20.7941 6 19.8C6 18.8059 6.80588 18 7.8 18C8.79412 18 9.6 18.8059 9.6 19.8Z"
                    fill="white"
                  />
                  <path
                    d="M18.0004 19.8C18.0004 20.7941 17.1945 21.6 16.2004 21.6C15.2063 21.6 14.4004 20.7941 14.4004 19.8C14.4004 18.8059 15.2063 18 16.2004 18C17.1945 18 18.0004 18.8059 18.0004 19.8Z"
                    fill="#F9FAFB"
                  />
                  <path
                    d="M3.60039 4.80005C2.93765 4.80005 2.40039 5.33731 2.40039 6.00005V18C2.40039 18.6628 2.93765 19.2 3.60039 19.2H4.8604C5.13836 17.8307 6.34901 16.8 7.80039 16.8C9.25177 16.8 10.4624 17.8307 10.7404 19.2H12.0004C12.6631 19.2 13.2004 18.6628 13.2004 18V6.00005C13.2004 5.33731 12.6631 4.80005 12.0004 4.80005H3.60039Z"
                    fill="#F9FAFB"
                  />
                  <path
                    d="M16.7996 8.40002C16.1368 8.40002 15.5996 8.93729 15.5996 9.60002V16.86C15.7935 16.8207 15.9942 16.8 16.1996 16.8C17.651 16.8 18.8617 17.8307 19.1396 19.2H20.3996C21.0624 19.2 21.5996 18.6628 21.5996 18V12C21.5996 11.6818 21.4731 11.3765 21.2481 11.1515L18.8481 8.75149C18.6231 8.52646 18.3178 8.40002 17.9996 8.40002H16.7996Z"
                    fill="#F9FAFB"
                  />
                </svg>
              </div>
              <div className="ms-3">
                ...
                <p className="mb-0 opacity-8">Need it fast? No worries!</p>
              </div>
            </div>
          </div>
        </div>
